...
public class SpecificCuisineAdapter extends RecyclerView.Adapter<SpecificCuisineAdapter.MyViewHolder>{

    private static final String Tag="Specific cuisine Adapter";
    ...
    public void setCuisineItemList(List<MealsDetails> allMealsList) {
    ...
    public SpecificCuisineAdapter(Context context, List<MealsDetails> allMealsList, AddToFavorites listener, OnMealClickedListener mealListener)
    {
